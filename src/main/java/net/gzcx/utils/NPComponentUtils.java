...
public class NPComponentUtils {
     ...
     * @return the j label
     */
    public static JLabel createLabel_root(
            String text, final NinePatch n9, Insets is, Color foregroundColor, Font f) {
        JLabel l =
                new JLabel(text) {
        ...
        if (foregroundColor != null) l.setForeground(foregroundColor);
