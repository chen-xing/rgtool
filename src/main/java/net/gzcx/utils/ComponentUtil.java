...
public class ComponentUtil {
    ...
    private static Insets screenInsets =
            Toolkit.getDefaultToolkit()
                    .getScreenInsets(MainFrame.getInstance().getGraphicsConfiguration());
    ...
    public static void setPreferSizeAndLocateToCenter(
            Component component, int preferWidth, int preferHeight) {
        component.setBounds(
                (screenWidth - preferWidth) / 2,
                (screenHeight - preferHeight) / 2,
                preferWidth,
                preferHeight);
    ...
    public static void setPreferSizeAndLocateToCenter(
            Component component, double preferWidthPercent, double preferHeightPercent) {
