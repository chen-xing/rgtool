...
public class FloatableDialog extends JDialog implements ActionListener {
     ...
     */
    public static FloatableDialog createDialog(
            JComponent contentCom, Window parentWindow, JComponent parentCom) {
     ...
     * Show this dialog.
     *
     * <p>This method invoke {@link #refreshLocation()} first, and then set this.setVisible(true).
     *
     * @see #refreshLocation()
     */
    public void display() {
        if (refreshLocation()) this.setVisible(true);
        timer.start();
    }
     ...
     * Exit this dialog.
     *
     * <p>If invisibleOnDispose == true then this.setVisible(false), else this.dispose().
     *
     * @see #isInvisibleOnDispose()
     */
    public void exit() {
        if (invisibleOnDispose) this.setVisible(false);
        else this.dispose();
    }
